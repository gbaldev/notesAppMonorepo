...
const Fire: React.FC<ExtendedIconProps> = ({size = 24, priority = 'low'}) => {
  const colors: {[key: string]: {high: string; medium: string; low: string}} = {
    high: {
      high: '#ff4c0d',
      medium: '#fc9502',
      low: '#fce202',
  ...
  return (
    <Svg height={size} width={size} viewBox="-33 0 255 255" fill="#000000">
      <Defs>
        <LinearGradient
          ...
          x2="94.141"
          y2="0.188">
          <Stop offset="0" stopColor={colors[priority].high ?? '##ff4c0d'} />
          <Stop offset="1" stopColor={colors[priority].medium ?? '#fc9502'} />
        </LinearGradient>
      </Defs>
      <G id="fire">
        <Path
        ...
        <Path
          ...
          fill={colors[priority].medium ?? '#fc9502'}
          fillRule="evenodd"
        />
        <Path
          ...
          fill={colors[priority].low ?? '#fce202'}
          fillRule="evenodd"
        />
      </G>
    </Svg>
